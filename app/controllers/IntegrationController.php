...
class IntegrationController extends \BaseController {
    ...
    public function __construct(\IntegrationSystem\core\IntegrationSystem $integrationService)
    {
    ...
    {
        //OK
        $url = 'http://api.seatgeek.com/2/events?venue.city=NY';
        ...
        $url = 'http://api.seatgeek.com/2/events?venue.city=NY&per_page=60&format=xml';
        $extension = 'XML';
        try {
            $this->integrationService->integrateAnOpenDataSource($url, $extension, "asd", "as");
        }
